...
var (
	...
	TitleStyle                  = lipgloss.NewStyle().Bold(true).Foreground(roseColor).MarginBottom(4).Inline(true)
	...
	PomoPausedStyle             = lipgloss.NewStyle().Foreground(mauveColor).Bold(true).Padding(0, 1).Margin(1, 0)
